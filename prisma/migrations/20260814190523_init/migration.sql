...
CREATE TABLE "User" (
    ...
    "emailTokenAttempts" INTEGER NOT NULL DEFAULT 0,
    "phoneToken" TEXT,
    "phoneTokenExpiry" TIMESTAMP(3),
    "phoneTokenAttempts" INTEGER NOT NULL DEFAULT 0,
...
-- CreateIndex
CREATE UNIQUE INDEX "User_regToken_key" ON "User"("regToken");
